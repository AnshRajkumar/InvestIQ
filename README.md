...
> A comprehensive, full-stack web platform for financial education and AI-powered investment analysis.

[![License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![GitHub Issues](https://img.shields.io/github/issues/AnshRajkumar/InvestIQ)](https://github.com/AnshRajkumar/InvestIQ/issues)
[![GitHub Forks](https://img.shields.io/github/forks/AnshRajkumar/InvestIQ)](https://github.com/AnshRajkumar/InvestIQ/network)

## ✨ Features

- 🤖 **AI-Powered Analysis** - Uses Claude AI for intelligent investment predictions
- 📊 **Real-time Data** - Live stock data and sentiment analysis
- 👤 **User Profiles** - Complete authentication and profile management
- 💼 **Portfolio Management** - Track and analyze your investments
- 📚 **Learning Modules** - Educational content for financial literacy
- 🔐 **Secure** - JWT authentication with production-ready security

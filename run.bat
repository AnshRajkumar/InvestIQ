@echo off
REM InvestIQ Full Stack Startup Script for Windows

echo.
echo 🚀 Starting InvestIQ Full Stack Application
echo ===========================================
echo.
...
start "InvestIQ Backend" python manage.py runserver 0.0.0.0:8000
...
start "InvestIQ Frontend" cmd /k npm run dev

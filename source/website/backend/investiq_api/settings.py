"""
Django settings for investiq_api project.
...
# Allow Railway and Vercel domains by default
...
INSTALLED_APPS = [
    ...
    # Custom apps
    'investiq_api.apps.authentication',
    'investiq_api.apps.prediction',
...
ROOT_URLCONF = 'investiq_api.urls'

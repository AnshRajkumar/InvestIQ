...
```sql
CREATE DATABASE festronix_db;
CREATE USER festronix WITH PASSWORD 'password';
ALTER ROLE festronix SET client_encoding TO 'utf8';
ALTER ROLE festronix SET default_transaction_isolation TO 'read committed';
ALTER ROLE festronix SET default_transaction_deferrable TO on;
ALTER ROLE festronix SET timezone TO 'UTC';
GRANT ALL PRIVILEGES ON DATABASE festronix_db TO festronix;
```

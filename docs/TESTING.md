...
```bash
python manage.py test festronix_api.apps.authentication
python manage.py test festronix_api.apps.prediction
```
...
from rest_framework.test import APIClient
from rest_framework import status
from festronix_api.apps.prediction.models import StockPrediction
from festronix_api.apps.prediction.utils import MockStockDataProvider, AIPredictor
...
from rest_framework.test import APIClient
from rest_framework import status
from festronix_api.apps.portfolio.models import Portfolio, PortfolioHolding
...
from rest_framework.test import APIClient
from rest_framework import status
from festronix_api.apps.news.utils import MockNewsProvider
  ...
  test:
    ...
    steps:
      ...
      - name: Check code quality
        run: |
          pip install flake8
          flake8 festronix_api --count --select=E9,F63,F7,F82 --show-source --statistics
```
